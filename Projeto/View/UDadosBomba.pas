...
uses UDMBanco, UEnumerado, UClasseBomba, UControllerBomba;

procedure TFDadosBomba.BBOKClick(Sender: TObject);
var objClasse: TBomba;
    objControle: TControleBomba;
begin
  inherited;
